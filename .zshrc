...
plugins=(aliases ag git node npm docker docker-compose docker-machine web-search yarn zsh-completions zsh-autosuggestions zsh-syntax-highlighting command-not-found extract brew z)
